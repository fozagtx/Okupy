...
agent = BuilderEventAgent(memory, ExaSearch(settings.exa_api_key, EXA_SEARCH_URL))
...
@app.get("/health")
def health() -> dict:
    return {"ok": True, "agent": "builder-events", "search": "exa", "channel": "photon-imessage", "memory": True}
